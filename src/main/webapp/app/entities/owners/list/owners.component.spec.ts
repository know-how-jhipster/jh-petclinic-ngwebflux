...
describe('Owners Management Component', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [RouterTestingModule.withRoutes([{ path: 'owners', component: OwnersComponent }]), HttpClientTestingModule],
      ...
      .overrideTemplate(OwnersComponent, '')
      .compileComponents();
  ...
  describe('trackId', () => {
    it('Should forward to ownersService', () => {
      const entity = { id: 123 };
      jest.spyOn(service, 'getOwnersIdentifier');
      const id = comp.trackId(0, entity);
      expect(service.getOwnersIdentifier).toHaveBeenCalledWith(entity);
