...
describe('Vets Management Component', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [RouterTestingModule.withRoutes([{ path: 'vets', component: VetsComponent }]), HttpClientTestingModule],
      ...
      .overrideTemplate(VetsComponent, '')
      .compileComponents();
  ...
  describe('trackId', () => {
    it('Should forward to vetsService', () => {
      const entity = { id: 123 };
      jest.spyOn(service, 'getVetsIdentifier');
      const id = comp.trackId(0, entity);
      expect(service.getVetsIdentifier).toHaveBeenCalledWith(entity);
